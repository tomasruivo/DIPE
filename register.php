							...
							<header id="header">
								<div class="inner">
									...
									<!-- Nav -->
										<nav id="nav">
											<ul>
												<li><a href="#">Publicação de ideia</a></li>
												<li>
													<a href="#">procura de ideias</a>
													<ul>
												...
												<li class="current_page_item"><a href="#">Idioma</a></li>
...
<body>
    ...
    <div class="wrapper" align="center">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p align="center">Já tem uma conta? <a href="login.php">Entre aqui</a>.</p>
        </form>
    </div> 
    <!-- Contact -->
									<section>
